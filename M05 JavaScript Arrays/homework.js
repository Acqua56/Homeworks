...
function devolverUltimoElemento(array) {
   ...
   var last = arrayContiene[arrayContiene.length-1];
   return (last);
}
...
function obtenerLargoDelArray(array) {
   ...
   // Tu código:
   var arrayTamaño = array;

   return arrayTamaño.length;
}
...
function multiplicarArgumentos() {
 ...
 // Verificar si se pasó un solo argumento
